...
## 随机信号及相关函数
### 均值
$$\mu_x = \lim_{T \to \infty} \frac{1}{T} \int_0^T x(t) dt$$
### 方差
$$\sigma_x^2 = \lim_{T \to \infty} \frac{1}{T} \int_0^T (x(t) - \mu_x)^2 dt$$
### 均方值
$$\psi_x^2 = \lim_{T \to \infty} \frac{1}{T} \int_0^T x^2(t) dt$$
### 均方值、均值与方差的关系
$$\psi_x^2 = \mu_x^2 + \sigma_x^2$$
### 均方根值
$$X_{rms} = \sqrt{\lim_{T \to \infty} \frac{1}{T} \int_0^T x^2(t) dt}$$
### 相关系数
