...
imgs_dir = args.imgs_dir + 'src_m' + str(args.model_num) + '_eps_' + str(args.max_epsilon)
...
def save_records(acc, model_name='1', save_dir=record_dir):
    acc_record_path = save_dir + 'src_m' + str(args.model_num) + '_eps_' + str(args.max_epsilon) + \
