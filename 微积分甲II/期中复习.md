...
切平面的法矢量即曲面在该点的法线
$$\dfrac{x-x_0}{F'_x(x_0,y_0,z_0)}=\dfrac{y-y_0}{F'_y(x_0,y_0,z_0)}=\dfrac{z-z_0}{F'_z(x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           _0,y_0,z_0)}$$
## 多元函数微分学
### 多元函数的极限与连续性
...
0,(x,y)=(0,0)\end{cases}$，求$f_x'(0,0),f_y'(0,0)$，讨论$f$在点$(0,0)$处的可微性  并求$f$在$(0,0)$的方向导数
解：  
...
#### 旋度rot
$\displaystyle rot\vec{F}=\nabla\times\vec{F}=\begin{vmatrix} \vec{i} & \vec{j} &\vec{k} \\ \dfrac{\partial}{\partial x} & \dfrac{\partial}{\partial y} & \dfrac{\partial}{\partial x} \\ P & Q & R\end{vmatrix}=\left(\frac{\partial R}{\partial y}-\frac{\partial Q}{\partial z}\right)dydz+\left(\frac{\partial P}{\partial z}-\frac{\partial R}{\partial x}\right)dzdx+\left(\frac{\partial Q}{\partial x}-\frac{\partial P}{\partial y}\right)dxdy$ 